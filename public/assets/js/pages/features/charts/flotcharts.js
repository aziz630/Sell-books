...
var KTFlotchartsDemo = function() {
	...
	var demo8 = function() {
		var data = [
            {label: "CSS", data: 1, color:  KTApp.getSettings()['colors']['theme']['base']["primary"]},
            {label: "HTML5", data: 1, color:  KTApp.getSettings()['colors']['theme']['base']["success"]},
            {label: "PHP", data: 1, color:  KTApp.getSettings()['colors']['theme']['base']["danger"]},
            {label: "Angular", data: 1, color:  KTApp.getSettings()['colors']['theme']['base']["warning"]}
        ];
