						...
						<div class="login-signin">
                            ...
                            @csrf
                                ...
                                <div class="form-group">
                                    <input class="form-control h-auto text-white bg-white-o-5 rounded-pill border-0 py-4 px-8" type="text" name="name" :value="old('name')" required placeholder="Name" autocomplete="off" />
                                </div>
								<div class="form-group">
									<input class="form-control h-auto text-white bg-white-o-5 rounded-pill border-0 py-4 px-8" type="email" name="email" :value="old('email')" required placeholder="Email" autocomplete="off" />
								</div>
								<div class="form-group">
                                ...
                                <div class="form-group">
									<input class="form-control h-auto text-white bg-white-o-5 rounded-pill border-0 py-4 px-8" type="password" placeholder="Confirm Password " name="password_confirmation" required />
								</div>
                                <div class="form-group">
									<input class="form-control h-auto text-white bg-white-o-5 rounded-pill border-0 py-4 px-8" type="number" placeholder="Phone " name="phone" required />
								</div>
                                <div class="form-group">
									<input class="form-control h-auto text-white bg-white-o-5 rounded-pill border-0 py-4 px-8" type="text" placeholder="Address " name="address" required />
								</div>
								
								<div class="form-group text-center mt-10">
									<button id="" type="submit" class="btn btn-pill btn-primary opacity-90 px-15 py-3">Sign Up</button>
								</div>
							</form>
							<div class="mt-10">
								<span class="opacity-40 mr-4">Already registered?</span>
								<a href="{{ route('login') }}" id="" class="text-white opacity-30 font-weight-normal">Sign In</a>
							</div>
						</div>
